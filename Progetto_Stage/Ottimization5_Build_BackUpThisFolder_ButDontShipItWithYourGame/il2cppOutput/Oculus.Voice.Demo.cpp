...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void InteractionHandler_OnRequestStarted_m83068F763A4FA73AA096E05777DCFD1BBDC80100 (InteractionHandler_t74C2739B8802D8C3091024A6B1AC3CBF0FF49158* __this, WitRequest_t9EBE9541762EBC83F63DE8E549A47CD273F212A6* ___r0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_3);
		Action_1__ctor_m9DC2953C55C4D7D4B7BEFE03D84DA1F9362D652C(L_3, __this, (intptr_t)((void*)InteractionHandler_U3COnRequestStartedU3Eb__7_0_mC3761300CB3459B355E041B5DEBE45A7586DE1B7_RuntimeMethod_var), NULL);
		NullCheck(L_2);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void InteractionHandler_Update_m4DA5F3B930906BF1278A4A763188C0A959F7437D (InteractionHandler_t74C2739B8802D8C3091024A6B1AC3CBF0FF49158* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		String_t* L_3 = __this->___pendingText_8;
		NullCheck(L_2);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void InteractionHandler_ToggleActivation_mBE8FCE9DD4490FC004355A5C3FD7E70133B1DB20 (InteractionHandler_t74C2739B8802D8C3091024A6B1AC3CBF0FF49158* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_3);
		VirtualActionInvoker0::Invoke(29 /* System.Void Facebook.WitAi.VoiceService::Deactivate() */, L_3);
		goto IL_002c;
	}
...
IL_001e:
	{
		...
		NullCheck(L_4);
		VirtualActionInvoker0::Invoke(25 /* System.Void Facebook.WitAi.VoiceService::Activate() */, L_4);
	}
...
IL_0012:
	...
	}
	{
		...
		__this->____time_4 = ((float)il2cpp_codegen_subtract(L_3, L_4));
		// if (_time < 0)
		float L_5 = __this->____time_4;
...
IL_001a:
	{
		...
		float* L_3 = (&__this->____time_4);
		bool L_4;
		L_4 = TimerController_ParseTime_m25BABC642C0208A41E7A92EFC5A941EDF41625FF(__this, L_2, L_3, NULL);
		V_1 = L_4;
		bool L_5 = V_1;
		if (!L_5)
		{
...
IL_001d:
	{
		...
		StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248* L_2 = ___entityValues0;
		bool L_3;
		L_3 = TimerController_ParseTime_m25BABC642C0208A41E7A92EFC5A941EDF41625FF(__this, L_2, (&V_0), NULL);
		V_2 = L_3;
		bool L_4 = V_2;
		if (!L_4)
		{
	...
	}
	{
		...
		float L_13 = V_0;
		__this->____time_4 = ((float)il2cpp_codegen_subtract(L_12, L_13));
		// if (_time < 0)
		float L_14 = __this->____time_4;
...
IL_001d:
	...
	}
	{
		...
		float L_5 = __this->____time_4;
		float L_6 = V_0;
		__this->____time_4 = ((float)il2cpp_codegen_add(L_5, L_6));
...
IL_0019:
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_11, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&TimerController_ParseTime_m25BABC642C0208A41E7A92EFC5A941EDF41625FF_RuntimeMethod_var)));
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void WitActivation_OnValidate_m3D8CF22DCDFA711328CAF2065917C65BC02EBA27 (WitActivation_t834A6232A011D0754D463EFB3B3CA1F02688F836* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___voiceExperience_4 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___voiceExperience_4), (void*)L_3);
	}
