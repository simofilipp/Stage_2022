	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_CloudMap = packedInput.ase_texcoord5.xy * _CloudMap_ST.xy + _CloudMap_ST.zw;
				float clampResult257 = clamp( _CloudMult , 0.0 , 1.0 );
				
				surfaceDescription.Albedo = ( _CloudsBaseColor * _CloudMult ).rgb;
				surfaceDescription.Normal = lerpResult253.rgb;
				...
				surfaceDescription.Emission = ( _DarkSideEmission * ( 1.0 - clampResult43 ) ).rgb;
				surfaceDescription.Smoothness = _CloudSmoothness;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( tex2D( _CloudMap, uv_CloudMap ) * clampResult257 ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_CloudMap = packedInput.ase_texcoord.xy * _CloudMap_ST.xy + _CloudMap_ST.zw;
				float clampResult257 = clamp( _CloudMult , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_CloudMap = packedInput.ase_texcoord1.xy * _CloudMap_ST.xy + _CloudMap_ST.zw;
				float clampResult257 = clamp( _CloudMult , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_CloudMap = packedInput.ase_texcoord3.xy * _CloudMap_ST.xy + _CloudMap_ST.zw;
				float clampResult257 = clamp( _CloudMult , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_CloudMap = packedInput.ase_texcoord7.xy * _CloudMap_ST.xy + _CloudMap_ST.zw;
				float clampResult257 = clamp( _CloudMult , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18900
391;165;1862;1143;-3522.857;45.44099;1.091851;True;True
...
WireConnection;265;0;123;0
WireConnection;265;1;253;0
WireConnection;265;6;126;0
WireConnection;265;7;119;0
WireConnection;265;9;256;0
ASEEND*/
//CHKSM=31B947B92DAC53A448F1EC747FC0183AE38B84D8