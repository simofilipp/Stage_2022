	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 hsvTorgb125 = RGBToHSV( packedInput.ase_color.rgb );
				float VertColorSaturationMask141 = hsvTorgb125.y;
				float temp_output_115_0 = ( 1.0 - VertColorSaturationMask141 );
				
				float2 uv_NormalTex = packedInput.ase_texcoord5.xy * _NormalTex_ST.xy + _NormalTex_ST.zw;
				...
				float2 uv_OceanGridTex = packedInput.ase_texcoord5.xy * _OceanGridTex_ST.xy + _OceanGridTex_ST.zw;
				float2 temp_cast_2 = (0.015).xx;
				float2 texCoord295 = packedInput.ase_texcoord5.xy * float2( 2,1 ) + float2( 0,0 );
				...
				float fresnelNdotV160 = dot( normalWS, V );
				...
				float2 uv_CountriesBordersMask = packedInput.ase_texcoord5.xy * _CountriesBordersMask_ST.xy + _CountriesBordersMask_ST.zw;
				...
				float2 uv_CountriesTex = packedInput.ase_texcoord5.xy * _CountriesTex_ST.xy + _CountriesTex_ST.zw;
				...
				float3 hsvTorgb381 = RGBToHSV( packedInput.ase_color.rgb );
				...
				surfaceDescription.Albedo = ( OceansColor199 * temp_output_115_0 ).rgb;
				surfaceDescription.Normal = unpack187;
				...
				surfaceDescription.Emission = lerpResult163.rgb;
				surfaceDescription.Smoothness = ( (0.95 + (temp_output_115_0 - 0.0) * (1.0 - 0.95) / (1.0 - 0.0)) * _Smoothness );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = (1.0 + (VertColorSaturationMask141 - 0.0) * (_CountriesOpacity - 1.0) / (1.0 - 0.0));
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_NormalTex = packedInput.ase_texcoord.xy * _NormalTex_ST.xy + _NormalTex_ST.zw;
				float3 unpack187 = UnpackNormalScale( tex2D( _NormalTex, uv_NormalTex ), ( _NormalScale * VertColorSaturationMask141 ) );
				unpack187.z = lerp( 1, unpack187.z, saturate(( _NormalScale * VertColorSaturationMask141 )) );
				
				float2 uv_OceanGridTex = packedInput.ase_texcoord.xy * _OceanGridTex_ST.xy + _OceanGridTex_ST.zw;
				float2 temp_cast_2 = (0.015).xx;
				float2 texCoord295 = packedInput.ase_texcoord.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner303 = ( _TimeParameters.x * temp_cast_2 + texCoord295);
				float simplePerlin3D322 = snoise( float3( panner303 ,  0.0 )*15.0 );
				simplePerlin3D322 = simplePerlin3D322*0.5 + 0.5;
				float2 temp_cast_4 = (-0.015).xx;
				...
				float4 StripesMaskCountries335 = ( 0.22 * tex2D( _SelectionTexCountries, rotator332 ) * CameraDepthFade348 );
				float4 temp_output_109_0 = ( _BorderColor * 4.0 );
				float2 uv_CountriesBordersMask = packedInput.ase_texcoord.xy * _CountriesBordersMask_ST.xy + _CountriesBordersMask_ST.zw;
				float temp_output_123_0 = ( _BorderWidth + -0.1 );
				float temp_output_35_0 = ( temp_output_123_0 + 0.01 );
				float clampResult32 = clamp( tex2D( _CountriesBordersMask, uv_CountriesBordersMask ).r , temp_output_123_0 , temp_output_35_0 );
				float BordersMask144 = ( CameraDepthFade348 * ( 1.0 - (0.0 + (clampResult32 - temp_output_123_0) * (1.0 - 0.0) / (temp_output_35_0 - temp_output_123_0)) ) * VertColorSaturationMask141 );
				...
				float blendOpDest306 = simplePerlin3D201;
				float NoiseAnimSmall300 = (0.2 + (( saturate( (( blendOpDest306 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest306 ) * ( 1.0 - blendOpSrc306 ) ) : ( 2.0 * blendOpDest306 * blendOpSrc306 ) ) )) - 0.0) * (1.2 - 0.2) / (1.0 - 0.0));
				float2 uv_CountriesTex = packedInput.ase_texcoord.xy * _CountriesTex_ST.xy + _CountriesTex_ST.zw;
				float4 temp_output_374_0 = ( _CountriesTexValue * tex2D( _CountriesTex, uv_CountriesTex ) );
				float4 temp_output_372_0 = ( ( _CountriesTexTintHighlights * temp_output_374_0 ) + ( _CountriesTexTintShadows * ( 1.0 - temp_output_374_0 ) ) );
				float3 hsvTorgb381 = RGBToHSV( packedInput.ase_color.rgb );
				float3 hsvTorgb390 = RGBToHSV( temp_output_372_0.rgb );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_NormalTex = packedInput.ase_texcoord7.xy * _NormalTex_ST.xy + _NormalTex_ST.zw;
				float3 unpack187 = UnpackNormalScale( tex2D( _NormalTex, uv_NormalTex ), ( _NormalScale * VertColorSaturationMask141 ) );
				unpack187.z = lerp( 1, unpack187.z, saturate(( _NormalScale * VertColorSaturationMask141 )) );
				
				float2 uv_OceanGridTex = packedInput.ase_texcoord7.xy * _OceanGridTex_ST.xy + _OceanGridTex_ST.zw;
				float2 temp_cast_2 = (0.015).xx;
				float2 texCoord295 = packedInput.ase_texcoord7.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner303 = ( _TimeParameters.x * temp_cast_2 + texCoord295);
				float simplePerlin3D322 = snoise( float3( panner303 ,  0.0 )*15.0 );
				simplePerlin3D322 = simplePerlin3D322*0.5 + 0.5;
				float2 temp_cast_4 = (-0.015).xx;
				...
				float4 StripesMaskCountries335 = ( 0.22 * tex2D( _SelectionTexCountries, rotator332 ) * CameraDepthFade348 );
				float4 temp_output_109_0 = ( _BorderColor * 4.0 );
				float2 uv_CountriesBordersMask = packedInput.ase_texcoord7.xy * _CountriesBordersMask_ST.xy + _CountriesBordersMask_ST.zw;
				float temp_output_123_0 = ( _BorderWidth + -0.1 );
				float temp_output_35_0 = ( temp_output_123_0 + 0.01 );
				float clampResult32 = clamp( tex2D( _CountriesBordersMask, uv_CountriesBordersMask ).r , temp_output_123_0 , temp_output_35_0 );
				float BordersMask144 = ( CameraDepthFade348 * ( 1.0 - (0.0 + (clampResult32 - temp_output_123_0) * (1.0 - 0.0) / (temp_output_35_0 - temp_output_123_0)) ) * VertColorSaturationMask141 );
				...
				float blendOpDest306 = simplePerlin3D201;
				float NoiseAnimSmall300 = (0.2 + (( saturate( (( blendOpDest306 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest306 ) * ( 1.0 - blendOpSrc306 ) ) : ( 2.0 * blendOpDest306 * blendOpSrc306 ) ) )) - 0.0) * (1.2 - 0.2) / (1.0 - 0.0));
				float2 uv_CountriesTex = packedInput.ase_texcoord7.xy * _CountriesTex_ST.xy + _CountriesTex_ST.zw;
				float4 temp_output_374_0 = ( _CountriesTexValue * tex2D( _CountriesTex, uv_CountriesTex ) );
				float4 temp_output_372_0 = ( ( _CountriesTexTintHighlights * temp_output_374_0 ) + ( _CountriesTexTintShadows * ( 1.0 - temp_output_374_0 ) ) );
				float3 hsvTorgb381 = RGBToHSV( packedInput.ase_color.rgb );
				float3 hsvTorgb390 = RGBToHSV( temp_output_372_0.rgb );
...
/*ASEBEGIN
Version=18900
391;165;1862;1143;-1808.935;-295.5409;1;True;True
...
WireConnection;401;0;159;0
WireConnection;401;1;187;0
WireConnection;401;6;163;0
WireConnection;401;7;190;0
WireConnection;401;9;128;0
ASEEND*/
//CHKSM=0930697115886AE91CBE48EF6B11737336229831