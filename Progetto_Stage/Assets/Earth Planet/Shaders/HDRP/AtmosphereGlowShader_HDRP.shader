...
Shader "AtmosphereGlowShader_HDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_102_0 = ( ( 1.0 - fresnelNode57 ) * clampResult104 );
				float dotResult17 = dot( -_DirectionalLightDatas[0].forward , normalWS );
				...
				float4 clampResult173 = clamp( lerpResult111 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				
				surfaceDescription.Albedo = _AtmosphereColor.rgb;
				...
				surfaceDescription.Emission = _AtmosphereColor.rgb;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = clampResult173.r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float clampResult104 = clamp( fresnelNode101 , 0.0 , 1.0 );
				float temp_output_102_0 = ( ( 1.0 - fresnelNode57 ) * clampResult104 );
				float dotResult17 = dot( -_DirectionalLightDatas[0].forward , ase_worldNormal );
				float4 temp_cast_2 = (dotResult17).xxxx;
				float4 clampResult96 = clamp( CalculateContrast(_DayNightContrast,temp_cast_2) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_cast_3 = (temp_output_102_0).xxxx;
				float4 lerpResult111 = lerp( ( temp_output_102_0 * clampResult96 ) , temp_cast_3 , _DarkSideMult);
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				float fresnelNdotV57 = dot( ase_worldNormal, V );
				float fresnelNode57 = ( 0.0 + ( ( 1.0 - _GlowScaleOutside ) * 20.0 ) * pow( 1.0 - fresnelNdotV57, 10.0 ) );
				float fresnelNdotV101 = dot( ase_worldNormal, V );
				float fresnelNode101 = ( 0.0 + ( _GlowScaleInside * 20.0 ) * pow( 1.0 - fresnelNdotV101, 3.0 ) );
				float clampResult104 = clamp( fresnelNode101 , 0.0 , 1.0 );
				float temp_output_102_0 = ( ( 1.0 - fresnelNode57 ) * clampResult104 );
				float dotResult17 = dot( -_DirectionalLightDatas[0].forward , ase_worldNormal );
...
/*ASEBEGIN
Version=18900
936;280;1862;1143;-3719.051;-197.8356;1.3;True;True
Node;AmplifyShaderEditor.RangedFloatNode;59;2593.541,788.6711;Inherit;False;Property;_GlowScaleOutside;GlowScale Outside;0;0;Create;True;0;0;0;False;0;False;0.6;0.6;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;2684.099,1153.79;Inherit;False;Property;_GlowScaleInside;GlowScale Inside;1;0;Create;True;0;0;0;False;0;False;0.12;0.12;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;101;3423.126,1099.402;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;3354.339,601.6622;Float;False;Property;_DayNightContrast;DayNight Contrast;3;0;Create;True;0;0;0;False;0;False;4;4;0;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;57;3373.471,774.0703;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;10;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;104;3752.827,1113.434;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;97;4043.52,684.7719;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;102;4257.765,936.8746;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;112;4295.957,1228.718;Float;False;Property;_DarkSideMult;DarkSideMult;2;0;Create;True;0;0;0;False;0;False;0.022;0.022;0;1;0;1;FLOAT;0
...
WireConnection;162;6;144;0
WireConnection;162;9;173;0
ASEEND*/
//CHKSM=05DD1CAD297729E40518D27E1481A66EFE9183A2